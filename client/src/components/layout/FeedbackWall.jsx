...
export function FeedbackWall() {
    const { activeProduct, feedback, addFeedback, dateRangeStart, dateRangeEnd } = useStore();
    ...
    return (
        <div className="bg-background-app flex flex-1 flex-col h-full overflow-hidden relative">
            {/* Header */}
                ...
                {productFeedback.length === 0 ? (
                    ...
                    (() => {
                        ...
                        productFeedback.forEach((fb) => {
                            ...
                            const dateKey = parts.length > 1 ? parts[1].trim() : fb.postedDate;
