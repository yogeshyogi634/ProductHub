...
const STATUS_OPTIONS = ["WIP", "Backlog", "Completed"];
const DEPT_TYPES = ["Product", "Engineering", "Design", "Sales", "Finance", "Operations"];
...
export function NewUpdateModal() {
    ...
    const validate = () => {
        ...
        if (!stripHtml(description).trim()) e.description = "Description is required";
        return e;
    };
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-lg py-md border-b border-stroke-default-primary-v2">
                        <div className="flex flex-col gap-2xs">
                            ...
                            <span className="text-xs text-text-default-secondary">
                                ...
                                <span className="text-text-default-primary font-medium">{activeProduct}</span>
                            </span>
                        </div>
                        <button
                            type="button"
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-md p-lg">
                        ...
                        <div className="flex flex-col gap-2xs">
                            ...
                            />
                            {errors.title && (
                                <span className="text-xs text-background-actions-error">{errors.title}</span>
                            )}
                        </div>
                        ...
                        <div className="flex flex-col gap-2xs">
                            <label className="text-xs font-medium text-text-default-secondary">
                                Description <span className="text-background-actions-error">*</span>
                            </label>
                            <RichTextEditor
                                value={description}
                                onChange={(html) => {
                            ...
                            />
                            {errors.description && (
                                <span className="text-xs text-background-actions-error">{errors.description}</span>
                            )}
                        </div>

                        {/* Status */}
                        <div className="flex flex-col gap-2xs">
                            <label className="text-xs font-medium text-text-default-secondary">Status</label>
                        ...
                        {/* Department */}
                        <div className="flex flex-col gap-2xs">
                            <label className="text-xs font-medium text-text-default-secondary">Department</label>
                            <select
